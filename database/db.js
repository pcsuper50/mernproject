...
import mongoose from 'mongoose';
  ...
  export const Connection = async (URL) => {
   ...
   // const url = `mongodb://${username}:${password}@ac-olmzie1-shard-00-00.nbgwvws.mongodb.net:27017,ac-olmzie1-shard-00-01.nbgwvws.mongodb.net:27017,ac-olmzie1-shard-00-02.nbgwvws.mongodb.net:27017/?ssl=true&replicaSet=atlas-wu5rbz-shard-0&authSource=admin&retryWrites=true&w=majority`;
    try{
